<?php
	...
	function Section_Take($cam) {
		...
		<div class="row">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body form-horizontal">
						...
						<fieldset id="saveToServerSettings" disabled>
							<div class="form-group ">
								<label class="col-md-5 control-label">Ubicacion de guardado</label>
								<div class="col-md-7">
						...
						<div class="form-group">
						 ...
						 <fieldset id="timelapseSettings" disabled>
							<div class="form-group " >
								<label class="col-md-5 control-label">Nombre de Lapso</label>
								<div class="col-md-7">
							...
							<div class="form-group" >
								<label class="col-md-5 control-label">Retardo entre capturas</label>
								<div class="col-md-7">
							...
							<div class="form-group" >
								<label class="col-md-5 control-label">Cantidad de capturas</label>
								<div class="col-md-7">
			...
			<div class="col-md-6">
				...
				<div class="panel panel-default">
					<div class="panel-heading" data-toggle="collapse" data-target="#divcapturesettings">Configuracion de captura</div>
					...
					<div class="panel-body form-horizontal collapse in" id="divcapturesettings">
						...
						<button class="btn btn-link" onclick="prompt('Current Settings Url', getCurrentSettingsUrl()); return false;">Url actual</button>
					</div>
				</div>
			</div>
		</div>
	...
	function Section_Commands() {
		?>
		<button onclick="return reboot();">Reiniciar</button>
		<?php 
	}
			...
			<div class="boxWithHead full">
				...
				<div class="body">
					<div class="row">
						...
						<div class="col-md-7">
							<div class="panel panel-default">
								<div class="panel-heading" >Subir Archivos: <button id="save_oba" onclick="return saveFilesInFolder();">Sharepoint</button></div>
